  ...
  console.log(currency.value)
    switch (currency.value) {
      ...
      case "EUR":
        ...
        Li11.firstElementChild.textContent = totalE.toFixed(2) + ' грн.'
        Li12.firstElementChild.textContent = (totalE / 1.2).toFixed(2) + ' грн.'
        Li13.firstElementChild.textContent = ((totalE / 1.2) * 1.05).toFixed(2) + ' грн.'
        Li14.firstElementChild.textContent = ((totalE / 1.2) * 1.1).toFixed(2) + ' грн.'
        Li15.firstElementChild.textContent = ((totalE / 1.2) * 1.15).toFixed(2) + ' грн.'
        Li16.firstElementChild.textContent = ((totalE / 1.2) * 1.2).toFixed(2) + ' грн.'
        Li17.firstElementChild.textContent = ((totalE / 1.2) * 1.25).toFixed(2) + ' грн.'
        Li18.firstElementChild.textContent = ((totalE / 1.2) * 1.3).toFixed(2) + ' грн.'
        break
      case "RUR":
        let rateR = data.find(elem => elem.ccy === "RUR")
        let totalR = Number(inputForm.value) * Number(rateR.sale)
        Li11.firstElementChild.textContent = totalR.toFixed(2) + ' грн.'
        Li12.firstElementChild.textContent = (totalR / 1.2).toFixed(2) + ' грн.'
        Li13.firstElementChild.textContent = ((totalR / 1.2) * 1.05).toFixed(2) + ' грн.'
        Li14.firstElementChild.textContent = ((totalR / 1.2) * 1.1).toFixed(2) + ' грн.'
        Li15.firstElementChild.textContent = ((totalR / 1.2) * 1.15).toFixed(2) + ' грн.'
        Li16.firstElementChild.textContent = ((totalR / 1.2) * 1.2).toFixed(2) + ' грн.'
        Li17.firstElementChild.textContent = ((totalR / 1.2) * 1.25).toFixed(2) + ' грн.'
        Li18.firstElementChild.textContent = ((totalR / 1.2) * 1.3).toFixed(2) + ' грн.'
        break
      case "BTC":
        let rateB = data.find(elem => elem.ccy === "BTC")
        let totalB = Number(inputForm.value) * Number(rateB.sale)
        Li11.firstElementChild.textContent = totalB.toFixed(2) + ' грн.'
        Li12.firstElementChild.textContent = (totalB / 1.2).toFixed(2) + ' грн.'
        Li13.firstElementChild.textContent = ((totalB / 1.2) * 1.05).toFixed(2) + ' грн.'
        Li14.firstElementChild.textContent = ((totalB / 1.2) * 1.1).toFixed(2) + ' грн.'
        Li15.firstElementChild.textContent = ((totalB / 1.2) * 1.15).toFixed(2) + ' грн.'
        Li16.firstElementChild.textContent = ((totalB / 1.2) * 1.2).toFixed(2) + ' грн.'
        Li17.firstElementChild.textContent = ((totalB / 1.2) * 1.25).toFixed(2) + ' грн.'
        Li18.firstElementChild.textContent = ((totalB / 1.2) * 1.3).toFixed(2) + ' грн.'
        break
      default:
        return
    }
